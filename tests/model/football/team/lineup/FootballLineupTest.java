...
public class FootballLineupTest {
    ...
    public void setUp() {
        ...
        p2 = new Defender("def", 2, "defTeam", 65, 487, 42, -31, 42, 86, 42);
        p3 = new Lateral("lat", 3, "latTeam", 32, 87, 42, 64, 56, 32, 46, 74);
        p4 = new Midfielder("mid", 4, "midTeam", 65, 76, 31, 42, 53, 64, 87, 96);
        p5 = new Striker("striker", 5, "strikeTeam", 52, 46, 24, 14, 6, 64, 46);
        ...
        fl1 = new FootballLineup("", 1, playing, subsitutes);
    ...
    public void addPlayerTest() {
        ...
        FootballPlayer dummy1 = new Striker("142", 2, "$", 32, 53, 534, 35, 21, 42, 421);
        ...
        FootballPlayer pFull = new Defender("ola", 9, "haha", 34, 53, 95, 29, 37, 5, 59);
    ...
    public void addSubstituteTest() {
        FootballPlayer newP = new Goalkeeper("yay", 1, "bomdia", 24, 53, 6, 60, 49, 48, 31, 44);
